...
public:
    ...
    void PerformBalancing(const ::Enisey::StringSequence& MatrixConnectionsFile, const ::Enisey::StringSequence& InOutGRSFile, const ::Enisey::StringSequence& PipeLinesFile, ::Enisey::StringSequence& ResultFile)
    {
        PerformBalancing(MatrixConnectionsFile, InOutGRSFile, PipeLinesFile, ResultFile, 0);
    }
    void PerformBalancing(const ::Enisey::StringSequence& MatrixConnectionsFile, const ::Enisey::StringSequence& InOutGRSFile, const ::Enisey::StringSequence& PipeLinesFile, ::Enisey::StringSequence& ResultFile, const ::Ice::Context& __ctx)
    {
        PerformBalancing(MatrixConnectionsFile, InOutGRSFile, PipeLinesFile, ResultFile, &__ctx);
    }
    ...
    void end_PerformBalancing(::Enisey::StringSequence& ResultFile, const ::Ice::AsyncResultPtr&);
    
private:

    void PerformBalancing(const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, ::Enisey::StringSequence&, const ::Ice::Context*);
...
public:
    ...
    virtual void PerformBalancing(const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, ::Enisey::StringSequence&, const ::Ice::Context*) = 0;
};
...
public:
    ...
    virtual void PerformBalancing(const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, ::Enisey::StringSequence&, const ::Ice::Context*);
};
...
public:
    ...
    virtual void PerformBalancing(const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, const ::Enisey::StringSequence&, ::Enisey::StringSequence&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    typedef void (T::*Response)(const ::Enisey::StringSequence&);
    ...
    virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
    {
        ...
        try
        {
            __proxy->end_PerformBalancing(ResultFile, __result);
        }
        ...
        {
#if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
            (callback.get()->*response)(ResultFile);
#else
            (::IceInternal::CallbackNC<T>::callback.get()->*response)(ResultFile);
#endif
        }
    }
...
newCallback_GasTransferSystemIce_PerformBalancing(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::Enisey::StringSequence&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_GasTransferSystemIce_PerformBalancing<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_GasTransferSystemIce_PerformBalancingPtr
newCallback_GasTransferSystemIce_PerformBalancing(T* instance, void (T::*cb)(const ::Enisey::StringSequence&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_GasTransferSystemIce_PerformBalancing<T>(instance, cb, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Response)(const ::Enisey::StringSequence&, const CT&);
    ...
    virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
    {
        ...
        {
#if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
            (callback.get()->*response)(ResultFile, CT::dynamicCast(__result->getCookie()));
#else
            (::IceInternal::Callback<T, CT>::callback.get()->*response)(ResultFile, CT::dynamicCast(__result->getCookie()));
#endif
        }
    }
...
newCallback_GasTransferSystemIce_PerformBalancing(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::Enisey::StringSequence&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_GasTransferSystemIce_PerformBalancing<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_GasTransferSystemIce_PerformBalancingPtr
newCallback_GasTransferSystemIce_PerformBalancing(T* instance, void (T::*cb)(const ::Enisey::StringSequence&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_GasTransferSystemIce_PerformBalancing<T, CT>(instance, cb, excb, sentcb);
}
