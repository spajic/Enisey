/** \file test_slae_solver_i.cpp
  “есты дл€ класса SlaeSolverI из slae_solver_i.h*/
...
/// \todo ќтрефакторить тесты SlaeSolver - так чтобы в этот абстрактный
/// тест просто подставл€лись конкретные Solver'ы.