...
__device__ inline
double ReturnPNextSequentialCuda(
    double p_work, 
    double t_work, 
...
__device__ inline
double ReturnTNextSequentialCuda(
...
void FindSequentialOutCuda(
    ...
    double* t_out,
    double* p_out) { // out - параметры, значения на выходе 
