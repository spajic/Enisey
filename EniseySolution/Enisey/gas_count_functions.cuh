...
inline float FindC(float t_reduced, float p_reduced, float r_standart_conditions)
{
...
inline float FindLambda(float re, float d_inner, float roughness_coefficient, float hydraulic_efficiency_coefficient)
{
