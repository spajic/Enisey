...
class GraphBoostEdge {
 ...
 private:
  double p_min_passport_; ///< Минимальное давление по паспорту объекта.
  double p_max_passport_; ///< Максимальное давление по паспорту объекта.
  int in_vertex_id_; 
  int out_vertex_id_;
  int edge_id_vesta_;
  int edge_type_;
